...
export class TemplatesApi {
    ...
    public async create(
        ...
        options?: RequestOptions): Promise<CreateResponse<Template>> {
        const {
            workspaceId,
            ...template
        } = params || {};
    ...
    public async list(
        ...
        options?: RequestOptions): Promise<ApiResponse<TemplateCollection>> {
        const {
            workspaceId,
            limit = 20,
            offset = 0,
    ...
    public async retrieve(
        ...
        options?: RequestOptions): Promise<ApiResponse<Template>> {
        const {
            workspaceId,
            templateId,
        } = params || {};
