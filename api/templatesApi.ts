...
export class TemplatesApi {
    ...
    public async create(params?: {
        workspaceId: string,
    } & TemplateWrite, options?: RequestOptions): Promise<{ lastResponse: http.IncomingMessage, id: string } & Template> {
        const {
            workspaceId,
            ...template
        } = params || {};
    ...
    public async update(params?: {
        workspaceId: string,
        templateId: string,
    } & TemplateWrite, options?: RequestOptions): Promise<{ lastResponse: http.IncomingMessage }> {
        const {
            workspaceId,
            templateId,
            ...template
