...
export class UsersApi {
    ...
    public async create(
        ...
        options?: RequestOptions): Promise<CreateResponse<User>> {
        const {
            ...user
        } = params || {};
    ...
    public async list(
        ...
        options?: RequestOptions): Promise<ApiResponse<UserCollection>> {
        const {
            fieldname,
            sortOrder,
            sortFields,
    ...
    public async retrieve(
        ...
        options?: RequestOptions): Promise<ApiResponse<User>> {
        const {
            userId,
        } = params || {};
