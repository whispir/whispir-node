...
export class CustomListsApi {
     ...
     */
    public async list(
        params?: CustomListListParams,
        options?: RequestOptions): Promise<ApiResponse<CustomListCollection>> {
        const {
            limit = 20,
            offset = 0,
            sortOrder,
    ...
    public async retrieve(
        params?: CustomListRetrieveParams,
        options?: RequestOptions): Promise<ApiResponse<CustomList>> {
        const {
            customlistId,
        } = params || {};
