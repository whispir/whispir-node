...
import { MessageResponseCollection, MessageResponseCollectionWrite } from '../model/messageResponseCollection';
import { MessageStatusCollection, MessageStatusCollectionWrite } from '../model/messageStatusCollection';
...
export class MessagesApi {
    ...
    public async create(
        ...
        options?: RequestOptions): Promise<CreateResponse<Message>> {
        const {
            workspaceId,
            ...message
        } = params || {};
    ...
    public async list(
        ...
        options?: RequestOptions): Promise<ApiResponse<MessageCollection>> {
        const {
            workspaceId,
            limit = 20,
            offset = 0,
     ...
     */
    public async listMessageResponse(
        params?: MessageResponseListParams,
        options?: RequestOptions): Promise<ApiResponse<MessageResponseCollection>> {
        const {
            workspaceId,
            messageId,
            limit = 20,
            ...
            return new Promise((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "MessageResponseCollection");
    ...
    public async retrieve(
        ...
        options?: RequestOptions): Promise<ApiResponse<Message>> {
        const {
            workspaceId,
            messageId,
        } = params || {};
     ...
     */
    public async listMessageStatus(
        params?: MessageStatusListParams,
        options?: RequestOptions): Promise<ApiResponse<MessageStatusCollection>> {
        const {
            workspaceId,
            messageId,
            limit = 20,
            ...
            return new Promise((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "MessageStatusCollection");
