...
export class CallbacksApi {
    ...
    public async listCalls(
        params?: CallbackCallListParams,
        options?: RequestOptions): Promise<ApiResponse<CallbackCallCollection>> {
        const {
            callbackId,
            limit = 20,
            offset = 0,
    ...
    public async updateCall(
        params?: CallbackCallUpdateParams,
     ...
     */
    public async create(
        params?: CallbackCreateParams,
        options?: RequestOptions): Promise<CreateResponse<Callback>> {
        const {
            ...callback
        } = params || {};
    ...
    public async list(
        ...
        options?: RequestOptions): Promise<ApiResponse<CallbackCollection>> {
        const {
            limit = 20,
            offset = 0,
            sortOrder,
    ...
    public async retrieve(
        ...
        options?: RequestOptions): Promise<ApiResponse<Callback>> {
        const {
            callbackId,
        } = params || {};
