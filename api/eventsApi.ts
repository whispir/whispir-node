...
export class EventsApi {
     ...
     */
    public async createEvent (workspaceId: string, xApiKey: string, contentType: 'application/vnd.whispir.event-v1+json' | 'application/vnd.whispir.event-v1+xml', accept: 'application/vnd.whispir.event-v1+json' | 'application/vnd.whispir.event-v1+xml', event?: Event, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Event;  }> {
        ...
        if (workspaceId === null || workspaceId === undefined) {
            throw new Error('Required parameter workspaceId was null or undefined when calling createEvent.');
        }

        // verify required parameter 'xApiKey' is not null or undefined
        if (xApiKey === null || xApiKey === undefined) {
            throw new Error('Required parameter xApiKey was null or undefined when calling createEvent.');
        }

        // verify required parameter 'contentType' is not null or undefined
        if (contentType === null || contentType === undefined) {
            throw new Error('Required parameter contentType was null or undefined when calling createEvent.');
        }

        // verify required parameter 'accept' is not null or undefined
        if (accept === null || accept === undefined) {
            throw new Error('Required parameter accept was null or undefined when calling createEvent.');
        }
     ...
     */
    public async getEventById (workspaceId: string, eventId: string, xApiKey: string, accept: 'application/vnd.whispir.event-v1+json' | 'application/vnd.whispir.event-v1+xml', limit?: number, offset?: number, sortOrder?: 'asc' | 'desc', sortFields?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Event;  }> {
        const localVarPath = this.basePath + '/workspaces/{workspaceId}/events/{eventId}'
            .replace('{' + 'workspaceId' + '}', encodeURIComponent(String(workspaceId)))
        ...
        // verify required parameter 'workspaceId' is not null or undefined
        if (workspaceId === null || workspaceId === undefined) {
            throw new Error('Required parameter workspaceId was null or undefined when calling getEventById.');
        }
        ...
        // verify required parameter 'xApiKey' is not null or undefined
        if (xApiKey === null || xApiKey === undefined) {
            throw new Error('Required parameter xApiKey was null or undefined when calling getEventById.');
        }

        // verify required parameter 'accept' is not null or undefined
        if (accept === null || accept === undefined) {
            throw new Error('Required parameter accept was null or undefined when calling getEventById.');
        }
     ...
     * @param sortFields The fields that you require the ordering to be performed on. Multiple fields can be provided, separated by a comma.
     */
    public async getEvents (workspaceId: string, xApiKey: string, accept: 'application/vnd.whispir.event-v1+json' | 'application/vnd.whispir.event-v1+xml', eventType: string, limit?: number, offset?: number, sortOrder?: 'asc' | 'desc', sortFields?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetEvents200Response;  }> {
        const localVarPath = this.basePath + '/workspaces/{workspaceId}/events'
            .replace('{' + 'workspaceId' + '}', encodeURIComponent(String(workspaceId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        if (eventType === null || eventType === undefined) {
            throw new Error('Required parameter eventType was null or undefined when calling getEvents.');
        }
        ...
        localVarHeaderParams['X-Api-Key'] = ObjectSerializer.serialize(xApiKey, "string");
        localVarHeaderParams['Accept'] = ObjectSerializer.serialize(accept, "'application/vnd.whispir.event-v1+json' | 'application/vnd.whispir.event-v1+xml'");
        localVarHeaderParams['eventType'] = ObjectSerializer.serialize(eventType, "string");
        (<any>Object).assign(localVarHeaderParams, options.headers);
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: GetEvents200Response;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
     ...
     * @param event events object that needs to be create events
     */
    public async putEventById (workspaceId: string, eventId: string, xApiKey: string, contentType: 'application/vnd.whispir.event-v1+json' | 'application/vnd.whispir.event-v1+xml', accept: 'application/vnd.whispir.event-v1+json' | 'application/vnd.whispir.event-v1+xml', event?: Event, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/workspaces/{workspaceId}/events/{eventId}'
            .replace('{' + 'workspaceId' + '}', encodeURIComponent(String(workspaceId)))
            .replace('{' + 'eventId' + '}', encodeURIComponent(String(eventId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'workspaceId' is not null or undefined
        if (workspaceId === null || workspaceId === undefined) {
            throw new Error('Required parameter workspaceId was null or undefined when calling putEventById.');
        }

        // verify required parameter 'eventId' is not null or undefined
        if (eventId === null || eventId === undefined) {
            throw new Error('Required parameter eventId was null or undefined when calling putEventById.');
        }

        // verify required parameter 'xApiKey' is not null or undefined
        if (xApiKey === null || xApiKey === undefined) {
            throw new Error('Required parameter xApiKey was null or undefined when calling putEventById.');
        }

        // verify required parameter 'contentType' is not null or undefined
        if (contentType === null || contentType === undefined) {
            throw new Error('Required parameter contentType was null or undefined when calling putEventById.');
        }

        // verify required parameter 'accept' is not null or undefined
        if (accept === null || accept === undefined) {
            throw new Error('Required parameter accept was null or undefined when calling putEventById.');
        }
