...
export class EventsApi {
    ...
    public async create(
        ...
        options?: RequestOptions): Promise<CreateResponse<Event>> {
        const {
            workspaceId,
            ...event
        } = params || {};
    ...
    public async list(
        ...
        options?: RequestOptions): Promise<ApiResponse<EventCollection>> {
        const {
            workspaceId,
            eventType,
            limit = 20,
    ...
    public async retrieve(
        ...
        options?: RequestOptions): Promise<ApiResponse<Event>> {
        const {
            workspaceId,
            eventId,
            limit = 20,
