...
export class EventsApi {
    ...
    public async create(params?: {
        workspaceId: string,
    } & Event, options?: RequestOptions): Promise<{ lastResponse: http.IncomingMessage, id: string } & Event> {
        const {
            workspaceId,
            ...event
        } = params || {};
    ...
    public async update(params?: {
        workspaceId: string,
        eventId: string,
    } & Event, options?: RequestOptions): Promise<{ lastResponse: http.IncomingMessage }> {
        const {
            workspaceId,
            eventId,
            ...event
