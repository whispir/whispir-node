...
export class Message {
    ...
    */
    'type'?: Message.TypeEnum = Message.TypeEnum.Default;
    'features'?: Features;
    'resource'?: Resource;
    /**
    ...
    */
    'scheduleType'?: Message.ScheduleTypeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "Message.MessageTypeEnum"
        },
        {
            "name": "scheduleType",
            "baseName": "scheduleType",
            "type": "Message.ScheduleTypeEnum"
        },
        {
            "name": "scheduleDate",
...
export namespace Message {
    export enum TypeEnum {
        Default = <any> 'default',
        DefaultNoReply = <any> 'defaultNoReply',
        NoDlr = <any> 'noDlr'
    }
