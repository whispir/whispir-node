...
import { FeaturesAliasOption, FeaturesAliasOptionWrite } from './featuresAliasOption';
import { FeaturesPushOptions, FeaturesPushOptionsWrite } from './featuresPushOptions';


export type FeaturesWrite = {
    'pushOptions'?: FeaturesPushOptionsWrite;
    'aliasOption'?: FeaturesAliasOptionWrite;
}
