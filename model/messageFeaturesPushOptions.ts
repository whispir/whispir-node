...
import { MessageFeaturesPushOptionsAPNS, MessageFeaturesPushOptionsAPNSWrite } from './messageFeaturesPushOptionsAPNS';
import { MessageFeaturesPushOptionsFCM, MessageFeaturesPushOptionsFCMWrite } from './messageFeaturesPushOptionsFCM';


export type MessageFeaturesPushOptionsWrite = {
    /**
    ...
    */
    ...
    'fcm'?: MessageFeaturesPushOptionsFCMWrite;
    'apns'?: MessageFeaturesPushOptionsAPNSWrite;
    /**
...
*/
export class MessageFeaturesPushOptions {
    /**
    * A flag indicating whether notifications should be enabled for message replies.
    */
    'notifications': 'enabled' | 'disabled';
    ...
    */
    'priority': 'NORMAL' | 'HIGH';
    'fcm': MessageFeaturesPushOptionsFCM;
    'apns': MessageFeaturesPushOptionsAPNS;
    /**
    * Custom key-value pairs of the notification\'s payload. These values can be used by the target app for enhanced functionality provided that it has been designed to handle them (images, videos, links etc).  These attributes translate to <span style=\"color:red\">*data*</span>  in the FCM payload.  For APNS, the custom attributes of *data* are inserted as custom properties outside of the <span style=\"color:red\">*aps*</span> payload.
    */
    'data': object;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "fcm",
            "baseName": "fcm",
            "type": "MessageFeaturesPushOptionsFCM"
        },
        {
            "name": "apns",
            "baseName": "apns",
            "type": "MessageFeaturesPushOptionsAPNS"
        },
        {
            "name": "data",
            "baseName": "data",
    ...
    static getAttributeTypeMap() {
        return MessageFeaturesPushOptions.attributeTypeMap;
    }
}
