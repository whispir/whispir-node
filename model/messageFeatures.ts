...
import { MessageFeaturesAliasOption, MessageFeaturesAliasOptionWrite } from './messageFeaturesAliasOption';
import { MessageFeaturesPushOptions, MessageFeaturesPushOptionsWrite } from './messageFeaturesPushOptions';


export type MessageFeaturesWrite = {
    'pushOptions'?: MessageFeaturesPushOptionsWrite;
    'aliasOption'?: MessageFeaturesAliasOptionWrite;
}
...
export class MessageFeatures {
    'pushOptions': MessageFeaturesPushOptions;
    'aliasOption': MessageFeaturesAliasOption;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "MessageFeaturesPushOptions"
        },
        {
            "name": "aliasOption",
            "baseName": "aliasOption",
            "type": "MessageFeaturesAliasOption"
        }    ];

    static getAttributeTypeMap() {
        return MessageFeatures.attributeTypeMap;
    }
}
