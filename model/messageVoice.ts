...
import { MessageVoiceResources, MessageVoiceResourcesWrite } from './messageVoiceResources';


export type MessageVoiceWrite = {
    /**
    ...
    */
    'type': string;
    'resources'?: MessageVoiceResourcesWrite;
}
...
export class MessageVoice {
    ...
    */
    'other': '';
    'resources': MessageVoiceResources;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "resources",
            "baseName": "resources",
            "type": "MessageVoiceResources"
        }    ];

    static getAttributeTypeMap() {
        return MessageVoice.attributeTypeMap;
    }
}
